...
public class ParcelRegistrationData {
    ...
    public ParcelRegistrationData(String name, String distrito, String concelho, String freguesia, /*byte[] photo, byte[] document,*/ Point[] coordinates, long area, long perimeter){
        this.name = name;
